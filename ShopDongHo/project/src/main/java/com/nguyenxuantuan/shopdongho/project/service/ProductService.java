...
public interface ProductService {
	public List<ProductDTO> getDongHoNam();
	public List<ProductDTO> getDongHoNu();
	public List<ProductDTO> getSmartWatch();
	...
	public List<ProductDTO> getAllAdminProdcut();
}
...
class ProductServiceImpl implements ProductService{
	...
	@Override
	public List<ProductDTO> getDongHoNam() {
		List<ProductEntity> productEntities = productDao.getDongHoNam();
	...
	@Override
	public List<ProductDTO> getDongHoNu() {
		List<ProductEntity> productEntities = productDao.getDongHoNu();
		List<ProductDTO> productDTOs = new ArrayList<ProductDTO>();
		for(ProductEntity pro : productEntities) {
			ProductDTO productDTO = new ProductDTO();
			productDTO.setId(pro.getId());
	...
	@Override
	public List<ProductDTO> getSmartWatch() {
		List<ProductEntity> productEntities = productDao.getSmartWatch();
		List<ProductDTO> productDTOs = new ArrayList<ProductDTO>();
		for(ProductEntity pro : productEntities) {
			ProductDTO productDTO = new ProductDTO();
			productDTO.setId(pro.getId());
	...
	@Override
	public List<ProductDTO> searchProduct(String text) {
		List<ProductEntity> productEntities = productDao.searchProduct(text);
		List<ProductDTO> productDTOs = new ArrayList<ProductDTO>();
		for(ProductEntity pro : productEntities) {
			ProductDTO productDTO = new ProductDTO();
			productDTO.setId(pro.getId());
	...
	@Override
	public List<ProductDTO> getAllAdminProdcut() {
		List<ProductEntity> productEntities = productDao.getAllAdminProduct();
		List<ProductDTO> productDTOs = new ArrayList<ProductDTO>();
		for(ProductEntity pro : productEntities) {
			ProductDTO productDTO = new ProductDTO();
			productDTO.setId(pro.getId());
